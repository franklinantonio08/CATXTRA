...
<script type="text/javascript" src="{{ asset('../js/comun/secundariaModal.js') }}"></script>
                ...
                <div class="container px-2 my-2">
                    <form id="nuevoregistro" name="nuevoregistro" method="POST" action="{{ url()->current('/dist/especifica/nuevo') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-6 m-b-10">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Clasificacion Secundaria</span>
                                </div>
                                <input type="text" id="secundariaNombre" name="secundariaNombre" class="form-control" aria-label="Amount (to the nearest dollar)" readonly>
                                <input type="hidden" id="secundaria" name="secundaria" class="form-control" value="" >
                                <input type="hidden" id="secundariaCodigo" name="secundariaCodigo" class="form-control" value="" >
                                <div class="input-group-append">
                                    <span class="input-group-btn">
                                        <button type="button" id="agregarSecundaria" name="agregarSecundaria" class="btn waves-effect waves-light btn-warning"><i class="fa fa-plus"></i></button>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="col-sm-12">
                                    <div class="input-group m-b-10">
                                         <span class="input-group-addon">Cliente<span class="text-danger">&nbsp;*</span></span>
                                         <input type="text" id="clienteNombre" name="clienteNombre" class="form-control" placeholder="Buscar..." readonly>
                                         <input type="hidden" id="cliente" name="cliente" class="form-control" value="" >
                                         <span class="input-group-btn">
                                            <button type="button" id="agregarCliente" name="agregarCliente" class="btn waves-effect waves-light btn-warning"><i class="fa fa-plus"></i></button>
                                         </span>
                                    </div>
                                </div>
                                -->
...
@include('includes/secundarialist')
