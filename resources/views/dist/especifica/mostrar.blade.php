                ...
                <div class="container px-2 my-2">
                        ...
                        <div class="col-lg-6 m-b-10">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <label for="nombreGenerales">Nombre</label>
                                </div>
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="nombre" name="nombre" type="text" placeholder="Nombre" readonly value="{{$especifica->nombre}}"/>
                                    <label for="nombre">Nombre</label>
                                </div>
                               
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="codeEspecifica" name="codeEspecifica" type="text" placeholder="codeEspecifica" readonly value="{{$especifica->codeEspecifica}}"/>
                                    <label for="codeEspecifica">Codigo</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input class="form-control" id="estatus" name="estatus" type="text" placeholder="Estatus" readonly value="{{$especifica->estatus}}"/>
