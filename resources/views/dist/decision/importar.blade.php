        ...
        <div class="card mb-4">
            ...
            <div class="table-responsive">
                ...
                <div class="container px-2 my-2">
                    <form id="nuevoimportar" name="nuevoimportar" method="POST" action="{{ url()->current('/dist/comentario/importar') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                        <div class="col-lg-6 m-b-10">

                                <div class="form-floating mb-3">
                                    <a href="{{ asset('../plantillas/comentario.xlsx') }}" class="btn btn-primary m-b-5"> <i class="fa fa-cloud-download m-r-5"></i> <span>Descargar plantilla comentario</span></a>
                                </div>
