            ...
            <div class="table-responsive">
                ...
                <div class="container px-2 my-2">
                    <form id="nuevoregistro" name="nuevoregistro" method="POST" action="{{ url()->current('/dist/secundaria/nuevo') }}" enctype="multipart/form-data">
                            ...
                            <input type="hidden" id="secundariaId" name="secundariaId" value="{{$secundaria->id}}" class="form-control text-right" placeholder="">
                        ...
                        <div class="col-lg-6 m-b-10">
                                ...
                                <div class="form-floating mb-3">
                                    <input class="form-control" id="nombre" name="nombre" type="text" placeholder="nombre" value="{{$secundaria->nombre}}"/>
                                    <label for="nombre">Clasificacion Secundaria</label>
                                </div>

                                <div class="form-floating mb-3">
                                    <input class="form-control" id="codeSecundaria" name="codeSecundaria" type="text" placeholder="codeSecundaria" value="{{$secundaria->codeSecundaria}}"/>
                                    <label for="codeSecundaria">Clasificacion Secundaria Codigo </label>
                                </div>

                                <div class="form-floating mb-3">
                                    <textarea class="form-control" id="comentario" name="comentario" type="text" placeholder="Comentario" style="height: 10rem;" >{{$secundaria->comentario}}</textarea>
