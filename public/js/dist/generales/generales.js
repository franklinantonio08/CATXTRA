      ...
      $('#search').keypress(function(event){
        ...
        generales(search){
          ...
          const _this = this
              ...
              const table = $('#generales').DataTable( {
                  "destroy": true,
                  "searching": false,
                  "serverSide": true,
                  "info": true,
                  ...
                  "ajax": {
                      ...
                      "data": function ( d ) {
                          var info = $('#generales').DataTable().page.info();
          ...
          desactivargenerales(){
              ...
              $( ".desactivar" ).off('click');
                $( ".desactivar" ).click(function() {
                    ...
                    var opciones = {generalesId:generalesId};
                    const message = 'Seguro que desea cambiar de estatus el generales?'
                    const objConfirmacionmodal = new Confirmacionmodal(message, opciones, _this.callbackDesactivargenerales);
          ...
          callbackDesactivargenerales(response, opciones){
              ...
              if(response == true){
                  ...
                  {
                      generalesId: opciones.generalesId,
                      _token:token 
                      }
                  )
                  .done(function( data ) {
                    ...
                    console.log('por aqui vamos')
                      ...
                      if(data.response == true){
                          const modalTitle = 'GENERALES';
                          const modalMessage = 'El generales ha sido cambiado de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();

                          const objDistgeneraless = new Distgenerales();							
                          objDistgeneraless.init();	
                          //objDistgeneraless.generaless($( "#search" ).val());

                      }else{
                          
                          const modalTitle = 'GENERALES';
                          const modalMessage = 'El generales no se ha podido cambiar de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();
...
$(document).ready(function(){
  ...
  const objDistgenerales = new Distgenerales();
  objDistgenerales.init();
