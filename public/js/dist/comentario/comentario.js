      ...
      $('#search').keypress(function(event){
        ...
        comentario(search){
          ...
          const _this = this
              ...
              const table = $('#comentario').DataTable( {
                  "destroy": true,
                  "searching": false,
                  "serverSide": true,
                  "info": true,
                  ...
                  "ajax": {
                      ...
                      "data": function ( d ) {
                          var info = $('#comentario').DataTable().page.info();
          ...
          desactivarcomentario(){
              ...
              $( ".desactivar" ).off('click');
                $( ".desactivar" ).click(function() {
                    ...
                    const comentarioId = $( this ).attr( "attr-id" );
                    var opciones = {comentarioId:comentarioId};
                    const message = 'Seguro que desea cambiar de estatus el comentario?'
                    const objConfirmacionmodal = new Confirmacionmodal(message, opciones, _this.callbackDesactivarcomentario);
          ...
          callbackDesactivarcomentario(response, opciones){
              ...
              if(response == true){
                  ...
                  {
                      comentarioId: opciones.comentarioId,
                      _token:token 
                      }
                  )
                  .done(function( data ) {
                    ...
                    console.log('por aqui vamos')
                      ...
                      if(data.response == true){
                          const modalTitle = 'COMENTARIO';
                          const modalMessage = 'El comentario ha sido cambiado de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();

                          const objDistcomentario = new Distcomentario();							
                          objDistcomentario.init();	
                          //objDistcomentario.comentario($( "#search" ).val());

                      }else{
                          
                          const modalTitle = 'COMENTARIO';
                          const modalMessage = 'El comentario no se ha podido cambiar de estatus';
                          const objMessagebasicModal = new MessagebasicModal(modalTitle, modalMessage);
                          objMessagebasicModal.init();
